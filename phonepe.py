...
config ={
    ...
    'host':'127.0.0.1','database':'Sample_Phonepe_data'
    }
...
def Transaction_amount_count_Y(df, year):
    ...
    with col1:
        ...
        fig_amount= px.bar(tacyg, x="States", y="Insurance_amount", title=f"{year} INSURANCE AMOUNT",
                        color_discrete_sequence=px.colors.sequential.Rainbow,width=600, height= 650)
...
def Aggre_transaction_Y(df,year):
    ...
    with col1:
        ...
        fig_tra_amount= px.bar(aiyg, x="States", y= "Transaction_amount",title= f"{year} TRANSACTION AMOUNT",
                           width=600, height= 650, color_discrete_sequence=px.colors.sequential.Aggrnyl)
        st.plotly_chart(fig_tra_amount)
    with col2:

        fig_tra_count= px.bar(aiyg, x="States", y= "Transaction_count",title= f"{year} TRANSACTION COUNT",
                          width=600, height= 650, color_discrete_sequence=px.colors.sequential.Bluered_r)
        st.plotly_chart(fig_tra_count)
    ...
    with col1:
        ...
        fig_india_try_1= px.choropleth(aiyg, geojson= data1, locations= "States", featureidkey= "properties.ST_NM",
                                 ...
                                 hover_name= "States",title = f"{year} TRANSACTION AMOUNT",
                                 fitbounds= "locations",width =600, height= 600)
        fig_india_try_1.update_geos(visible =False)
        
        st.plotly_chart(fig_india_try_1)

    with col2:

        fig_india_try_2= px.choropleth(aiyg, geojson= data1, locations= "States", featureidkey= "properties.ST_NM",
                                 ...
                                 hover_name= "States",title = f"{year} TRANSACTION COUNT",
                                 fitbounds= "locations",width =600, height= 600)
        fig_india_try_2.update_geos(visible =False)
        
        st.plotly_chart(fig_india_try_2)
...
def Aggre_transaction_Y_Q(df,quarter):
    ...
    with col1:
        fig_tq_amount= px.bar(atyqg, x= "States", y= "Transaction_amount", 
                            title= f"{atyq['Years'].min()} AND {quarter} TRANSACTION AMOUNT",width= 600, height=650,
                            color_discrete_sequence=px.colors.sequential.Burg_r)
        st.plotly_chart(fig_tq_amount)

    with col2:
        fig_tq_count= px.bar(atyqg, x= "States", y= "Transaction_count", 
                            title= f"{atyq['Years'].min()} AND {quarter} TRANSACTION COUNT",width= 600, height=650,
                            color_discrete_sequence=px.colors.sequential.Cividis_r)
        st.plotly_chart(fig_tq_count)
    ...
    with col1:
        ...
        fig_india_t1= px.choropleth(atyqg, geojson= data1, locations= "States", featureidkey= "properties.ST_NM",
                                 color= "Transaction_amount", color_continuous_scale= "Sunsetdark",
                                 ...
                                 fitbounds= "locations",width =600, height= 600)
        fig_india_t1.update_geos(visible =False)
        
        st.plotly_chart(fig_india_t1)
    with col2:

        fig_india_t2= px.choropleth(atyqg, geojson= data1, locations= "States", featureidkey= "properties.ST_NM",
                                 color= "Transaction_count", color_continuous_scale= "Sunsetdark",
                                 ...
                                 fitbounds= "locations",width =600, height= 600)
        fig_india_t2.update_geos(visible =False)
        
        st.plotly_chart(fig_india_t2)
...
if select == "Data Exploration":
    ...
    with tab1:
        ...
        if method == "Insurance Analysis": 
            ...
            df_agg_insur_Y=Transaction_amount_count_Y(Aggre_insurance,years)
    ...
    with tab2:
        ...
        if method_map == "Map Insurance Analysis":
            ...
            df_map_insur_Y= Aggre_transaction_Y(Map_insurance,years_m1)
            ...
            df_map_insur_Y_Q= Aggre_transaction_Y_Q(df_map_insur_Y, quarters_m1)
    ...
    with tab3:
        ...
        if method_top == "Top Insurance Analysis":
            ...
            df_top_insur_Y= Aggre_transaction_Y(Top_insurance,years_t1)
            ...
            df_top_insur_Y_Q= Aggre_transaction_Y_Q(df_top_insur_Y, quarters_t1)
